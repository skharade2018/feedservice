# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-08-18 10:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(default=datetime.datetime(2018, 8, 18, 10, 16, 42, 438542))),
            ],
        ),
        migrations.CreateModel(
            name='Downvote',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=128)),
                ('created_on', models.DateTimeField(default=datetime.datetime(2018, 8, 18, 10, 16, 42, 441799))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(default=datetime.datetime(2018, 8, 18, 10, 16, 42, 439252))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(default=datetime.datetime(2018, 8, 18, 10, 16, 42, 437924))),
            ],
        ),
        migrations.CreateModel(
            name='Upvote',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=128)),
                ('created_on', models.DateTimeField(default=datetime.datetime(2018, 8, 18, 10, 16, 42, 441139))),
                ('answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='feed_models.Answer')),
            ],
        ),
        migrations.AddField(
